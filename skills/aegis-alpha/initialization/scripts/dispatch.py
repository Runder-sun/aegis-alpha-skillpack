...
def _init_guide(command: str, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    output["result"] = {
        ...
        "user_onboarding": guide.get("user_onboarding", {}) if isinstance(guide, dict) else {},
        "choices_path": str(_choices_path(workspace)),
        "profile_path": str(profile_path),
        "instructions": [
            "Before asking for credentials or writing state, present the user_onboarding first-run brief and configuration matrix in concise user-facing language.",
            "Guide the user one step at a time.",
            "Use user_onboarding.step_prompt_templates for the current_step.",
