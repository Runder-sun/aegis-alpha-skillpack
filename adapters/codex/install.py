...
from install_lib import env_home, install_native_skillset, parse_args, print_success  # noqa: E402


def main() -> int:
    home = env_home("CODEX_HOME", Path.home() / ".codex")
    args = parse_args(home / "skills", "Install Aegis Alpha Codex native skillset.")
